...
-- Description: Create new stored procedure to get meeting by Virtual class enrolment id.
-- Return meeting detail by id
-- ==============================================================================================
--Exec GET_Meeting_By_Virtual_Cls_Enrollment_Id 67
IF EXISTS(SELECT * FROM sys.objects WHERE Name = N'GET_Meeting_By_Virtual_Cls_Enrollment_Id')
BEGIN
    DROP PROC GET_Meeting_By_Virtual_Cls_Enrollment_Id
END
GO
Create PROC GET_Meeting_By_Virtual_Cls_Enrollment_Id
(
	@SysVcEnrollmentId INT
)
AS
BEGIN
	SELECT DISTINCT
	...
	WHERE M.SysVcEnrollmentId = @SysVcEnrollmentId
END
GO